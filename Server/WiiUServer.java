    ...
    */
    ...
    while (scanner.hasNextLine()) {
     ...
     if (line.equals("")) {
      ...
      String holdDataString = data.get("hold").toString().replace("E", "E+0");
      //System.out.println(holdDataString);
//      try {
       // Right Stick
       float XDeflection = data.get("rStickX");
       float YDeflection = data.get("rStickY");
       float lXDeflection = data.get("lStickX");
       float lYDeflection = data.get("lStickY");
